        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                   <li class="active">
                        <a href="projectmanager_main.jsp"><i class="fa fa-fw fa-dashboard"></i> Profile</a>
                    </li>
                    <li>
                        <a href="pm_add_jobs.jsp"><i class="fa fa-fw fa-bar-chart-o"></i>Jobs</a>
                    </li>
                    <li>
                        <a href="pm_status.jsp"><i class="fa fa-fw fa-table"></i>Status</a>
                    </li>
					<li>
					...
					<li>
                        <a href="pm_int.jsp"><i class="fa fa-fw fa-table"></i>Interviewers</a>
                    </li>
					<li>
                        <a href="pm_schedule_interview.jsp"><i class="fa fa-fw fa-table"></i>Schedule Interview</a>
                    </li>
					<li>
                        <a href="pm_assign_interviewer.jsp"><i class="fa fa-fw fa-table"></i>Assign Interview</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
