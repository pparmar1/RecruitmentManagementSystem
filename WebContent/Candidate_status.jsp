		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav side-nav">
					<li class="active"><a href="PmHomePage.jsp"><i
							class="fa fa-fw fa-dashboard"></i> Profile</a></li>
					<li><a href="pm_add_jobs.jsp"><i
							class="fa fa-fw fa-bar-chart-o"></i>Jobs</a></li>
					<!-- <li><a href="Candidate_status.jsp"><i
							class="fa fa-fw fa-table"></i>Status</a></li> -->
					<li><a href="pm_can.jsp"><i class="fa fa-fw fa-table"></i>Candidates</a>
					</li>
					<li><a href="referral_retrieve.jsp"><i
							class="fa fa-fw fa-table"></i>Referrals</a></li>
					<li><a href="pm_int.html"><i class="fa fa-fw fa-table"></i>Interviewers</a>
					</li>
