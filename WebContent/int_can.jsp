...
<%String username=(String)session.getAttribute("username");%>
    ...
    <div class="container">
 	...
 	IntService is=new IntServiceImpl();
           	...
           	List <Interviewer> list=is.retrieveInterviewerData(uname);
            	for(Interviewer ii :list){
			%>
			
			 <h3>Your Information</h3>
            <table class="table table-striped table-bordered">
            <tr><td>Schedule Id:</td><td><input type="text" name="name" value="<%=ii.getSchedule_id()%>" readonly></td></tr>
            <tr><td>Job Title</td><td><input type="text" name="name" value="<%=ii.getJob_title()%>"readonly></td></tr>
            <tr><td>Interview Date</td><td><input type="text" name="name" value="<%=ii.getDateString()%>"readonly></td></tr>
            <tr><td>Time:</td><td><input type="text" name="name" value="<%=ii.getTime()%>"readonly></td></tr>
