<%@page import="com.manipal.service.impl.JobServiceImpl,java.util.*,com.manipal.DAO.jdbc.*"%>
<%@page import="com.manipal.service.JobService"%>
<%@page import="com.manipal.model.AddJob, java.sql.*"%>
...
%>
	...
	<label> Location</label>
        <input type="text" class="form-control" name="location" required autofocus><br/>
