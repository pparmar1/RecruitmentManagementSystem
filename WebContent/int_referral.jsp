...
<body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li>
                        <a href="int_referral.jsp"><i class="fa fa-fw fa-table"></i>Referrals</a>
                    </li>
					<li>
                        <a href="int_can.jsp"><i class="fa fa-fw fa-table"></i>Candidates</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse --> 
    ...
    <div class="container">
		Interviewer referral will come here
    </div>
</div>	
</div>
    </div>
