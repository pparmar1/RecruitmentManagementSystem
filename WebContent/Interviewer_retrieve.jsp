...
IntService is=new IntServiceImpl();
	List<Interviewer> projectList = new ArrayList<Interviewer>();
	projectList = is.retrieveMethods();
	for(Interviewer s: projectList)
	{
		out.print("<tr>");
		out.print("<td>");
		out.println(s.getInterviewer_id());
		out.print("</td>");
		out.print("<td>");
		out.print(s.getEmployee_id());
		out.print("</td>");
		out.print("<td>");
		out.print(s.getJob_id());
		out.print("</td>");
		/* out.print("<td>");
		out.print(s.getInterviewer_Status());
		out.print("</td>"); */
